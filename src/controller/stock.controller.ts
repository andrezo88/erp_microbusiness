...
export class StockController {
  constructor(private stockService: StockService = new StockService()) {}

  async createStock(req: CustomRequest, res: Response, next: NextFunction) {
    try {
      ...
      await this.stockService.createStock(id, userId, userRole, value);
